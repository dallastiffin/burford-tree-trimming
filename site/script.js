...
(function () {
  ...
  /* ==================================================================
     ...
     previewing locally.
     ================================================================== */
  /* Burford's own Apps Script web app. NOT YET CREATED.
     ...
     It would have posted every Burford lead into somebody else's spreadsheet
     ...
     Replace the placeholder below with the /exec URL from the Burford leads
     spreadsheet once that Apps Script is deployed. It must be Burford's own
     ...
     already visited. */
  var SHEET_ENDPOINT = 'https://script.google.com/macros/s/AKfycbzGrSTiYyeTRx9OnHPIVzRvNDYywFAI3TsP5Y_0TuQ6puRMEqbDPRRPenq946mtIvKshA/exec';
