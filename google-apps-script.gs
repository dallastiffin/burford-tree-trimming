/**
 * Burford Tree Service — website lead handler
 * ========================================================
 *
 ...
 *  info@burfordtreeservice.com only works once email forwarding is
 ...
 */
function doGet() {
  return reply(true, 'Burford Tree Service lead endpoint is running.');
}
...
function sendAlert(data) {
  ...
  MailApp.sendEmail({
    to: NOTIFY_EMAIL,
    subject: 'New estimate request: ' + (data.service || 'Burford Tree Service'),
    body: lines.join('\n'),
