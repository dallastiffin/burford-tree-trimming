...
# --- business identity ----------------------------------------------------
BUSINESS      = "Burford Tree Service"
CITY          = "Burford"
PROVINCE      = "Ontario"
PROVINCE_CODE = "ON"
# Burford Township was one of the five townships merged with the Town of
# Paris on 1 January 1999 to form the single-tier County of Brant. The
# village itself is a Secondary Urban Settlement Area - limited infilling
# rather than growth - and much of it is still on private wells and septic.
REGION        = "the County of Brant"
CITY_PROV     = "%s, %s" % (CITY, PROVINCE)

PHONE_DISPLAY = "(226) 546-3837"
PHONE_HREF    = "+12265463837"
EMAIL         = "info@burfordtreeservice.com"
...
SERVICES_EYEBROW = "The Work We Take On"
...
HEADER_VARIANT = "tworow"
HERO_VARIANT   = "centre-stack"

# One line under the lead-form heading. Was a template literal, which put the
# same sentence on fifteen pages of every site in the build; now per city.
FORM_CALL_BLURB = "You are welcome to call us instead on {phone}."

# Browser UI colour. Must match --color-primary in site/style.css and
# theme_color in site/site.webmanifest.
# Burford runs bark brown (weight) + ochre (action). Each of the six Brant County sites takes a
...
CROP_OVERRIDES = {
    ...
    "Front yard Dead Branch.png": ((0.50, 0.50), 1.02),
}
...
DOMAIN = "https://www.burfordtreeservice.com"

# The markdown file holding all copy, in this folder.
CONTENT_FILE = "Burford-Tree-Trimming-Website-Content.md"
...
TOPBAR_AREA = "Burford &amp; the country west of Brantford"
...
MESSAGE_PLACEHOLDER = ("Tell us which tree it is, roughly how tall it stands, what is underneath it, and what is wrong with it. A dead limb, a lean, a split, storm damage, or a stump left behind are all common answers.")
...
"""
    ...
    # ---- centre-stack: photograph full bleed, copy centred in one column -
    if v == "centre-stack":
        return f"""
<section class="hero hero--home hero--centre-stack" aria-labelledby="hero-heading">
  <div class="hero__bg" aria-hidden="true">
{_hero_picture("")}
  </div>
  <div class="hero__scrim hero__scrim--centre" aria-hidden="true"></div>
  <div class="container hero__inner">
...
PAGE_PHOTOS = [
  ...
  ("Front yard Dead Branch.png", HERO_IMG, (4,3), [800,1200],
   f"Two-man crew roping a limb out of a big front-garden oak in {CITY}"),
  ("Front yard Dead Branch.png", "og-image", (1200,630), [1200],
   f"{BUSINESS} - tree trimming, tree removal and storm damage cleanup"),
  ("Trimming Small Tree from Ground.png", "service-tree-trimming-and-pruning", (16,10), [640,960],
   "Pole saw work on a small ornamental tree in a front garden"),
  ("Hollow Dead Branc.png", "service-dead-branch-removal", (16,10), [640,960],
   "Hollow dead trunk section lying on the grass beside a willow"),
  ("Garage.png", "service-emergency-storm-damage-cleanup", (16,10), [640,960],
   "Storm-thrown tree resting across the roof of a detached garage"),
  ("Tree Climber Cutting Branch 1.png", "service-tree-removal", (16,10), [640,960],
   "Climber cutting a limb back above a roofline"),
  ("Big Dead Branch.png", "service-crown-thinning-and-canopy-reduction", (16,10), [640,960],
   "Climber on a long horizontal limb with rigging lines set"),
  ("Dead Branch.png", "service-tree-cabling-and-bracing", (16,10), [640,960],
   "Split limb hanging off a trunk over an open lawn"),
  ("Grinding 2.png", "service-stump-grinding-and-removal", (16,10), [640,960],
   "Grinder working a stump in a fenced back garden"),
  ("Lowering Large Branch.png", ABOUT_IMG, (4,3), [800,1200],
   "Cut section flown clear on a crane sling above the lawn"),
  ("Grinding 5.png", SERVICES_IMG, (4,3), [800,1200],
   "Raking out the chip after a stump has been ground down"),
]

GALLERY_PHOTOS = [
  ("Scaling Ash Tree.png", "burford-1",
   "Climber ascending the trunk of a dying ash on rope and spikes"),
  ("Car.png", "burford-2",
   "Ice-loaded tree down across a parked car after freezing rain"),
  ("Small Hand Saw.png", "burford-3",
   "Hand saw finishing a pruning cut back to the branch collar"),
  ("Lift Bucket 2.png", "burford-4",
   "Bucket truck raised into a street tree from the road"),
]
