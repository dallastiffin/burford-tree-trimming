# Burford Tree Service — Handover

Site for **Burford Tree Service**, Burford, Ontario. Phone (226) 546-3837. Domain `www.burfordtreetrimming.com`.
...
| Check | Result |
|---|---|
| Words of body copy | 16,018 |
| Head-term density, site-wide | 4.12% (target 4.0%) |
| Verbatim overlap with the five sibling city sites | 0.99%–2.89% (6-word runs, paragraph text) |
| Certification / accreditation claims | 0 |
| Colour-contrast failures | 0 of 27 computed ratios |
| Dead internal links | 0 |
| Missing images | 0 |
| Duplicate meta descriptions | 0 |
| Initial page weight (home) | 303 KB |
...
6. **Only then attach `www.burfordtreetrimming.com`.**
